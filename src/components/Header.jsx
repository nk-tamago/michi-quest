...
import { Settings, Camera, Map } from 'lucide-react';

export default function Header({ currentTab, onChangeTab }) {
    const tabs = [
        { id: 'mission', label: 'ミッション', icon: <Map size={20} /> },
        { id: 'report', label: '達成報告', icon: <Camera size={20} /> },
        ...
        <header className="bg-earth-800 text-earth-100 shadow-md sticky top-0 z-50">
            <div className="max-w-3xl mx-auto px-4">
                <div className="flex justify-between items-center h-16">
                    <h1 className="text-xl font-bold tracking-widest">MichiQuest</h1>
